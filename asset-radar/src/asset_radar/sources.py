...
DEFAULT_SOURCES = [
    ...
    SourceSpec(
        source_id="coamc_orient_disposal",
        name="东方资产处置公告",
        source_type="amc_notice",
        url="https://sales.coamc.com.cn/coamc/notice/notice",
        max_pages=5,
        page_size=25,
        notes="China Orient public disposal notices; scans relevant dropdown categories through the notice API.",
    ),
    SourceSpec(
        source_id="gwamcc_international_disposal",
        name="长城国际资产处置公告",
        source_type="amc_notice",
        url="https://www.gwamcc.com.hk/cgwamc/zzczgg/index.html",
        max_pages=4,
        page_size=20,
        notes="Great Wall International static paginated asset disposal notices.",
    ),
    SourceSpec(
